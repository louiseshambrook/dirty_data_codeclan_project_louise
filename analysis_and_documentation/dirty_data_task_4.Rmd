...
- include documentation for all decisions, e.g. why dropping certain columns
...
Beginning to join the dataframes - examine the difference between frames
```{r}
setdiff(names(clean_2015), names(clean_2016))
setdiff(names(clean_2015), names(clean_2017))

setdiff(names(clean_2016), names(clean_2015))
setdiff(names(clean_2016), names(clean_2017))

setdiff(names(clean_2017), names(clean_2015))
setdiff(names(clean_2017), names(clean_2016))


# Adding/renaming columns to the 2015 dataset
...
# Adding/renaming the 2016 dataset
...
# Adding/renaming the 2017 dataset
